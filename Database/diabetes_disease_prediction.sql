...
--
-- Database: `diabetes_disease_prediction`
--
CREATE DATABASE IF NOT EXISTS `diabetes_disease_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `diabetes_disease_prediction`;
...
(53, 'Type2', '13.28125'),
(54, 'Type1', '20.3125'),
(55, 'No Diabetic', '64.32291666666666'),
(56, 'Low Diabetic', '0.9114583333333334'),
(57, 'Very Low Diabetic', '1.171875');
...
--
-- Table structure for table `remote_user_diabetes_disease_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_diabetes_disease_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Pregnancies` varchar(300) NOT NULL,
...
--
-- Table structure for table `remote_user_diabetes_disease_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_diabetes_disease_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Pregnancies` varchar(300) NOT NULL,
  `Glucose` varchar(300) NOT NULL,
  `BloodPressure` varchar(300) NOT NULL,
