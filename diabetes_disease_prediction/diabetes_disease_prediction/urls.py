"""diabetes_disease_prediction URL Configuration
...
from diabetes_disease_prediction import settings
...
urlpatterns = [
    ...
    url(r'^Search_Predict_Diabetic_DataSets/$', remoteuser.Search_Predict_Diabetic_DataSets, name="Search_Predict_Diabetic_DataSets"),
    ...
    url(r'^Find_Diabetic_Type_Ratio/$', serviceprovider.Find_Diabetic_Type_Ratio, name="Find_Diabetic_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Diabetic_Emergency_Details/$', serviceprovider.View_Diabetic_Emergency_Details, name="View_Diabetic_Emergency_Details"),
    url(r'^Find_Diabetic_Status_Details/$', serviceprovider.Find_Diabetic_Status_Details, name="Find_Diabetic_Status_Details"),
